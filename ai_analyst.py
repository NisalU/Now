...
class AIAnalyst:
    ...
    def _post_groq_model(self, model, system_prompt, payload_text, timeout=60):
        """Single HTTP POST to Groq's OpenAI-compatible chat/completions
        endpoint. Returns (model, content_str) on success.
    ...
    def _call_groq_models(self, system_prompt, payload_text):
        ...
        for model in models:
            try:
                ...
                result = self._post_groq_model(model, system_prompt, payload_text)
